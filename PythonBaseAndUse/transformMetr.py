...
sizepoint = {"mile" : 1609, "yard" : 0.9144, "foot" : 0.3048, "inch" : 0.0254, "km" : 1000, "m" : 1, "cm" : 0.01, "mm" : 0.001}
n, din, shlak, dout = input().split()
print("{:.2e}".format((float(n) * sizepoint[din] / sizepoint[dout])))
