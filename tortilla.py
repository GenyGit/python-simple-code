...
#Программе подаётся на вход число команд n n n, которые нужно выполнить черепашке, после чего n n n строк с самими командами.
# Вывести нужно два числа в одну строку: первую и вторую координату конечной точки черепашки. Все координаты целочисленные.

#dic = {x: y for x in range(4) for y in range(4)} -----------  быстрая генерация словаря
x, y = 0, 0
